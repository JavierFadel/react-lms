            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-indigo-500 dark:text-indigo-400 font-semibold">Question {currentQuestionIndex + 1} of {quiz.questions.length}</p>
                    </div>
                    <div className="text-2xl font-bold text-red-500 bg-red-100 dark:bg-red-900/50 px-4 py-2 rounded-lg">
                        <Clock className="inline-block h-6 w-6 mr-2" />
                ...
                <div className="mt-8 flex justify-between">
                    <button onClick={handlePrevious} disabled={currentQuestionIndex === 0} className="px-6 py-2 font-semibold rounded-lg bg-gray-200 dark:bg-gray-600 disabled:opacity-50">Previous</button>
